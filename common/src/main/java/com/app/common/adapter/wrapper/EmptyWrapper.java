...
public class EmptyWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (isEmpty()) {
            ViewHolder holder;
            if (mEmptyView != null) {
                holder = ViewHolder.Companion.createViewHolder(parent.getContext(), mEmptyView);
            } else {
                holder = ViewHolder.Companion.createViewHolder(parent.getContext(), parent, mEmptyLayoutId);
            }
            return holder;
        }
